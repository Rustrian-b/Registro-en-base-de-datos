 ...
 * @author H4HG
 */
@WebServlet(name = "salidaProducto", urlPatterns = {"/salidaProducto"})
public class salidaProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int vCodigo = Integer.parseInt(request.getParameter("codigo1"));
        int vCantidad = Integer.parseInt(request.getParameter("cantidad1"));
        ...
        while(iter.hasNext())
        {
            ...
            if(vCodigo == per.getvCodigo())  
            {
                ...
                if(vCantidadOriginal < vCantidad)
                {
                    ...
                    {                    
                        ...
                        out.println("</head>");
                        out.println("<body>");
                        out.println("<h1>Imposible realizar la operación solicitada</h1>");
                        out.println("<p>La cantidad a retirar es de " + vCantidad + " y el maximo disponible es de " + vCantidadOriginal + "</p>");
                ...
                }else
                {
                    ...
                    if(resp == 1)
                    {
                        try (PrintWriter out = response.getWriter()) 
                        {
                            ...
                            out.println("<p>Se han retirado: " + vCantidad + " unidades del producto " + vCodigo +"</p>");
